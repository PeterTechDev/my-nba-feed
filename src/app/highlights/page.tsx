          ...
          {highlights.map((h) => {
            ...
            return (
              ...
              >
                ...
                <div className="aspect-video bg-gradient-to-br from-red-600/20 to-black flex items-center justify-center relative">
                  <div className="w-14 h-14 rounded-full bg-red-600/80 flex items-center justify-center group-hover:bg-red-600 transition">
