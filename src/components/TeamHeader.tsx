...
export default function TeamHeader() {
  ...
  return (
    <div
      className="relative rounded-2xl p-6 sm:p-8 flex items-center gap-6 overflow-hidden"
      style={{
        background: `linear-gradient(135deg, ${team.primaryColor}40, ${team.secondaryColor}20, #0a0a0a)`,
      }}
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src={team.logo} alt={team.name} className="w-20 h-20 sm:w-28 sm:h-28 object-contain relative z-10" />
